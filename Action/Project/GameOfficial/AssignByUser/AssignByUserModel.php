...
class AssignByUserModel
{
    ...
    public $game;
    public $gameOfficial;
    public $gameOfficialOrg; // Cloned version of gameOfficial
    ...
    {   
        $changed = $this->workflow->process($this->project,$this->gameOfficialOrg,$this->gameOfficial,$this->projectOfficial);
        if ($changed)
        {
    ...
    { 
       // Extract
        ...
        $slotNum = $requestAttrs->get('_gameOfficial');
        $this->gameOfficial = $gameOfficial = $game->getOfficialForSlot($slotNum);
        ...
        // Adjust the official
        $this->gameOfficialOrg = clone $gameOfficial;
