...
// Stratton Format
class ConvertDstToYaml extends BaseLoader
{
    const GAME_NUM_OFFSET = 0;
    
    protected $record = array
    (
        'num'     => array('cols' => 'GAME', 'req' => true),
        'date'    => array('cols' => 'DATE', 'req' => true),
        'timeBeg' => array('cols' => 'TIME', 'req' => true),
        
        'field'    => array('cols' => 'FIELD','req' => true),
        
        'division'  => array('cols' => 'DIV', 'req' => true),
        'groupType' => array('cols' => 'TYPE','req' => true),
    ...
    protected function processItem($item)
    {
      ...
      //$fieldName = $this->getFieldName($item['field']);
        ...
        (
            ...
            'projectKey'    => 'AYSO_A5BGames_Spring2014',
